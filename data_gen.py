...
def generate_training_data(exp_sys_params, training_params, dataset_path, save_path):
    ...
    with h5py.File(save_path, "w") as hf:
        dset_images = hf.create_dataset("input_images", (len(image_files) * angles_number, *exp_sys_params["detector_size"], 1), dtype="float32")
        ...
        for img_path in image_files:
            ...
            for _ in range(angles_number):
                ...
                dset_images[index, :, :, 0] = normalize(fringe_image)
